...
inputs = tokenizer('left', return_tensors="pt")
outputs = model(**inputs)

inputs1 = tokenizer('democrat', return_tensors="pt")
outputs1 = model(**inputs1)


inputs2 = tokenizer('trump', return_tensors="pt")
outputs2 = model(**inputs2)
#pprint.pp(outputs.pooler_output[0])

# example = "Hillary is <mask>"
# fill_mask = pipeline('fill-mask', model=pretrained_LM_path, tokenizer=tokenizer)

# outputs3 = fill_mask(example)
# print(outputs3)
